...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "1941720069@student.polinema.ac.id" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("1941720069@student.polinema.ac.id", '1530164155') # Senders mail ID and password
        server.sendmail('1941720069@student.polinema.ac.id', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
